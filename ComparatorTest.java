...
class SalaryComparator implements Comparator<Girl>
{
	@Override
	public int compare(Girl o1, Girl o2) {
		System.out.println("SalaryComparator: "+o1.name+" started comparing salary with "+o2.name);
...
public class ComparatorTest {
	...
	public static void main(String[] args) {
		...
		Girl girl1 = new Girl("Reeta",6,50,23,10000);
		Girl girl2 = new Girl("Geeta",5.5f,55.6f,25,40000);
		Girl girl3 = new Girl("Meeta",4.4f,59.2f,22,25000);
		Girl girl4 = new Girl("Seeta",5.3f,63.2f,21,13000);
		Girl girl5 = new Girl("Neeta",5.2f,55.2f,25,65000);
		...
		do
		{
			...
			switch(choice)
			{
				...
				case 4: cmp = new SalaryComparator(); break;
				case 5: break;
			}
			if(cmp!=null) {
...
class Girl extends Person implements Comparable<Girl>
{
	...
	public Girl(String name, float height, float weight, int age,float salary) {
		super();
		this.name = name;
		this.height = height;
		this.weight = weight;
	...
	public String toString() {
		return "Girl [name=" + name + ", height=" + height + ", weight=" + weight + ", age=" + age + ", salary="
				+ salary + "]";
	}
